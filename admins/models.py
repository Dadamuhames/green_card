...
class Clients(models.Model):
    ...
    sex = models.CharField("Sex", max_length=255, default='Erkak', choices=GANDERS, blank=True, null=True)
    ...
    spouse_sex = models.CharField("Sex", max_length=255, default='Ayol', choices=GANDERS, blank=True, null=True)
